...
"@
$LinkedInSource1=@"
style='width:28.5pt;height:28.5pt'>
"@
$LinkedInDest1=@"
style='width:33.88pt;height:25.6pt'>
"@
$LinkedInSource2=@"
width=38 height=38
"@
...
$imageSourceDir = "C:\E-mail_Signature\images\*.jpg"
$ServerList = Get-Content "C:\E-mail_Signature\images\Serverlist.txt"
$sourceDir = "C:\E-mail_Signature\images\"
