...
if ($JobStatus -eq "[OK]"){
Write-Output ("SQL Backup<br>")("Status:              " + $OK) > C:\logdir\HealthCheck\SQL-Rush-Mercury.txt}
else {
Write-Output ("SQL Backup<br>")("Status:              " + $Failed) ("The following databaes have not had a full backup in the past week:<br>")  $FailList "<br>" > C:\logdir\HealthCheck\SQL-Rush-Mercury.txt}
