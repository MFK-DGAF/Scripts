...
# Variables
$ServerName = "RHEcho_DRTest"		                                   # Name of VM running Server Operating System
$SRAM = 8GB				                                       # RAM assigned to Server Operating System
$Server_OS_HD_Size = 80GB				                   
$Server_OS_HD_Loc = "E:\Hyper-V\Disks\RHEcho_DRTest.vhd"
$Server_Log_HD_Size = 50GB
$Server_Log_HD_Loc = "E:\Hyper-V\Disks\RHEcho_DRTest-Logs.vhd"
$Server_Data_HD_Size = 100GB
$Server_Data_HD_Loc = "E:\Hyper-V\Disks\RHEcho_DRTest-Data.vhd"
$Server_Bak_HD_Size = 100GB
$Server_Bak_HD_Loc = "E:\Hyper-V\Disks\RHEcho_DRTest-Backup.vhd"

$VM_Location = "E:\Hyper-V"			        # Location of the VM and VHDX files
$NetworkSwitch1 = "Hyper-V Wan Switch"	# Name of the Network Switch

$Install_ISO = "G:\Backup\SW_DVD5_Windows_Svr_DC_EE_SE_Web_2008_R2_64Bit_English_w_SP1_MLF_X17-22580.iso"	        # Windows Server 2008 ISO
...
New-VM -Name $ServerName -Path $VM_Location -MemoryStartupBytes $SRAM -SwitchName $NetworkSwitch1 -Generation 1
...
Add-VMHardDiskDrive -VMName $ServerName -ControllerType IDE -ControllerNumber 1 -ControllerLocation 0 -Path $Server_OS_HD_Loc
Add-VMHardDiskDrive -VMName $ServerName -ControllerType SCSI -ControllerNumber 1 -ControllerLocation 1 -Path $Server_LOG_HD_Loc
Add-VMHardDiskDrive -VMName $ServerName -ControllerType SCSI -ControllerNumber 1 -ControllerLocation 2 -Path $Server_DATA_HD_Loc
Add-VMHardDiskDrive -VMName $ServerName -ControllerType SCSI -ControllerNumber 1 -ControllerLocation 3 -Path $Server_BAK_HD_Loc
...
get-vm -name $ServerName | Get-VMNetworkAdapter | Set-VMNetworkAdapter -StaticMacAddress "00155D260260"
