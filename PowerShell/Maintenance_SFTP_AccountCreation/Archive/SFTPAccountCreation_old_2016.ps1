...
invoke-command -ComputerName $ADServer -ScriptBlock {New-ADUser -Name $args[0] -AccountPassword $args[1] -Description $args[2] -ChangePasswordAtLogon $false -Path "ou=RHA,DC=rhadata,DC=rushhealthassociates,dc=com" -Enabled $true -PasswordNeverExpires $true} -args $UserName, $PasswordString, $SFTPPath
...
$cfg.settings.access.winAccountsEx.new.xfer.mountPointsEx.new.realRootPath = "E:\PracticeSFTP\automation\Rush\caremanagement\MHN_2016\User"
$cfg.settings.access.winAccountsEx.new.xfer.mountPointsEx.new.realRootPath = "E:\PracticeSFTP\automation\AetnaACO"
$cfg.settings.access.winAccountsEx.new.xfer.mountPointsEx.new.realRootPath = "E:\PracticeSFTP\automation\CignaACO"
$cfg.settings.access.winAccountsEx.new.xfer.mountPointsEx.new.realRootPath = "E:\PracticeSFTP\automation\FHN"
...
#$cfg.settings.access.winAccountsEx.new.xfer.mountPointsEx.new.MountPoint(?)??()